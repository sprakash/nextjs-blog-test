...
const name = 'Shubhra Prakash'
export const siteTitle = 'Shubhra Prakash Blog'
            ...
            <header className={styles.header}>
                { home ? (
                    ...
                    <>
                        <Link href="/">
                            <a>
                                <Image priority src="/images/profile.jpg" className={utilStyles.borderCircle} height={100} width={100} alt={name} />
                            </a>
                        </Link>
